...
const USER_CONFIG = {
  ...
  // 如果你非要填这里也行。脚本也能运行
  APP_ID: 'wxed13d93991496d64',

  // 使用微信测试号时才需要填写：公众号APP_SECRET
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  APP_SECRET: '2e9a89d717db8d50297e97f001ebbb73',
  ...
  TIAN_API: {
    ...
    key: '3dbda93421dc3ac634bd9ff7b4a75013','3dbda93421dc3ac634bd9ff7b4a75013',
  ...
  USERS: [
    {
      ...
      useTemplateId: 'mhjyLnhowtURvmPwI6iF06IdIMDBN9QfYC9iel8eeJ4',
      // 所在省份或城市，也可以不填
      province: '上海',
      // 所在城市或县区
      city: '上海市',
  ...
  CALLBACK_TEMPLATE_ID: 'S4n00e6CjI-Wgahp2uli5X1Vzh3u6ZCtLsG8B2umqtE',
